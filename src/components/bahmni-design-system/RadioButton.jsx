...
import { RadioButton as CarbonRadioButton } from '@bahmni/design-system';
...
export class RadioButton extends Component {
  ...
  changeValue(option) {
    const errors = this._getErrors(option.value);
    this.setState({ hasErrors: this._hasErrors(errors) });
    this.props.onValueChange(option.value, errors);
  }
    ...
    return (
      ...
      >
        {options.map((option) => {
          ...
          const isChecked = this.props.value === option[this.props.valueKey];
          return (
            <CarbonRadioButton
              key={labelText}
